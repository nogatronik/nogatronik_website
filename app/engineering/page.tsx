      ...
      <ContentLandAnim style="flex flex-col md:flex-row gap-5 p-5">
        {SUBNAV.map((link, index) => (
          <Link
            key={index}
            href={link.href}
            className="group flex flex-col min-w-[250px] min-h-[300px] rounded-md bg-muted hover:shadow-onHover anim-transition"
          >
          ...
          -md py-5 m-2 group-hover:bg-primary group-hover:text-muted anim-transition"
            >
              {link.text}
            </small>
          </Link>
